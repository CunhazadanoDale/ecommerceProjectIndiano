...
import testando.indiano.config.AppConstants;
import testando.indiano.payload.ProductDTO;
import testando.indiano.payload.ProductResponse;
import testando.indiano.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<ProductDTO> uptadeProductImage(@PathVariable Long productId,
