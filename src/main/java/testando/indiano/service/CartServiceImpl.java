...
public class CartServiceImpl implements CartService{
    ...
    public CartDTO updateProductQuantityInCart(Long productId, Integer quantity) {
        ...
        if(cartItem == null) {
            throw new APIExceptions("Product " + product.getProductName() + " not avaliable in this cart");
        }

        int newQuamtity = cartItem.getQuantity() + quantity;
    ...
    public String deleteProductFromCart(Long cartId, Long productId) {
        ...
        return "Product " + cartItem.getProduct().getProductName() + " removed from this cart";
    }
    ...
    public void updateProductInCarts(Long cartId, Long productId) {
        ...
        if (cartItem == null) {
            throw new APIExceptions("Product " + product.getProductName() + " not available");
        }
